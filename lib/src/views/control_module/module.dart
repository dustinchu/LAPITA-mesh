...
class _ModuleState extends State<Module> {
      ...
      children: <Widget>[
        ...
        Column(
          children: [
            ...
            //               children: [
            //                 Text(
            //                     '${widget.devices.elementAt(i).name}\n${widget.devices.elementAt(i).id}'),
            //                 TextButton(
            //                   onPressed: () {
            //                     // _deinit();
            //                     widget.onDisconnect();
  ...
  //     deviceListName.add(await node.name);
  ...
  //   setState(() {
  //     // await subscript(context, widget.meshManagerApi, nodes[i].uuid);
  //     isLoading = false;
  //   });
  // }
