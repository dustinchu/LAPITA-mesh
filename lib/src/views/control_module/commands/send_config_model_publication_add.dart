...
class SendConfigModelPublicationAdd extends StatefulWidget {
  ...
  const SendConfigModelPublicationAdd(this.meshManagerApi, {Key? key})
      : super(key: key);

  @override
  State<SendConfigModelPublicationAdd> createState() =>
      _SendConfigModelPublicationAddState();
}

class _SendConfigModelPublicationAddState
    extends State<SendConfigModelPublicationAdd> {
