...
class SendGenericOnOff2 extends StatefulWidget {
  final MeshManagerApi meshManagerApi;

  const SendGenericOnOff2({Key? key, required this.meshManagerApi})
      : super(key: key);

  @override
  State<SendGenericOnOff2> createState() => _SendGenericOnOffState();
}

class _SendGenericOnOffState extends State<SendGenericOnOff2> {
